...
start_buttons = [
    ...
    [Button.url("🤖 Updates", "https://t.me/No1_Bots")],
]
...
async def helper(event):
    await event.edit(
        '**Usage instructions.**\n\nAdd me to your channel, as administrator, with "add users" permission, and forward me a message from that chat to set me up!\n\nTo approve members who are already in waiting list, upgrade to premium for 5$ per month! Contact @No1_Bots_Admin if interested.',
